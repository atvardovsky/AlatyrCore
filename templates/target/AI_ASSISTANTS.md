...
2. Load its semantic preload once; resolve lazy IDs through the semantic index,
   falling back to canonical owner prose on missing, stale, or conflicting terms.
