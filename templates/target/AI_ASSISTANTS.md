...
3. Read `.ai/framework/README.md` and the task-relevant framework docs,
   especially logical integrity, blueprint-driven change, skill and AI
   infrastructure adaptation, installed operations, and operation help
   guidance.
4. Read `.ai/project/contour.md` and `.ai/assistant/contour.md`.
5. Read `.ai/assistant/help.md` when the request asks for help, commands,
   existing AI infrastructure, adding AI infrastructure, or an unclear Alatyr
   action.
