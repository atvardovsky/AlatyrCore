...
def replacement(name: str) -> str:
    exact = {
        ...
        "TARGET_SELECTED_SURFACE_EVIDENCE_OR_UNKNOWN": "manual review",
        "TARGET_SURFACE_LIMITATION_OR_NONE": "fixture limitation",
        "TARGET_SURFACE_STATE_REVIEW_TRIGGER": "client changed",
