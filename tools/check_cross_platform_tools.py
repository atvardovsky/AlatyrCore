...
def main() -> int:
    ...
    if not NATIVE_WORKFLOW.is_file():
        ...
        for required in [
            ...
            "Check release evidence for version transitions",
            "git diff --quiet \"$ALATYR_BASE_SHA\" HEAD -- VERSION ADAPTER_SCHEMA_VERSION TEMPLATE_VERSION",
            "python tools/check_release_drift.py --mode release",
