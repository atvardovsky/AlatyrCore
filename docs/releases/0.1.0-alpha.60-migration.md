...
From manifest: `release-checkpoint:0.1.0-alpha.59:framework/rule-registry.json`
...
From framework directory: `release-checkpoint:0.1.0-alpha.59:framework`
...
From schema directory: `release-checkpoint:0.1.0-alpha.59:schemas`
...
From template directory: `release-checkpoint:0.1.0-alpha.59:templates/target`
