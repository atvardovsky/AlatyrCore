...
From framework directory: `/tmp/alatyr-alpha3/framework`
...
From schema directory: `/tmp/alatyr-alpha3-schemas`
...
From template directory: `/tmp/alatyr-alpha3/templates/target`
