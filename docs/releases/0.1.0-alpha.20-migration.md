...
From framework directory: `/tmp/alatyr-release-baseline-2nal3zgt/framework`
...
From schema directory: `/tmp/alatyr-release-baseline-2nal3zgt/schemas`
...
From template directory: `/tmp/alatyr-release-baseline-2nal3zgt/templates/target`
