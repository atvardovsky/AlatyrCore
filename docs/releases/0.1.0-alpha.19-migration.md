...
From framework directory: `/tmp/alatyr-release-baseline-53mk6z7w/framework`
...
From schema directory: `/tmp/alatyr-release-baseline-53mk6z7w/schemas`
...
From template directory: `/tmp/alatyr-release-baseline-53mk6z7w/templates/target`
