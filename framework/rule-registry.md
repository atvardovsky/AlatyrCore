...
canonical-owner digests, emit required term and owner-rule obligations with
word and character evidence in schema-4 packets, and fail closed to canonical
prose. Compose eager gates exactly from profile defaults and load conditional
